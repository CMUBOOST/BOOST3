...
FeedbackFloatAmbientTemperature, ///Ambient temperature inside the module (measured at the IMU chip), in degrees Celsius.
...
FeedbackNumberedFloatDebug, ///Values for internal debug functions (channel 1-10 available).
